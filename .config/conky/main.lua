...
${color3}${lua font icon_s  ${voffset $sr{-1}}${font :size=$sc{7}}▼}${font}${color}  ${downspeed <IFACE>} (${totaldown <IFACE>}) ${color3}${alignc $sr{-45}}${lua font h2 {<IFACE>}}${font}${color}#
${alignr}(${totalup <IFACE>}) ${upspeed <IFACE>} ${color3}${lua font icon_s  ${voffset $sr{-2}}${font :size=$sc{7}}▲}${font}${color}
${color4}${downspeedgraph <IFACE> $sr{32},$sr{130}} ${alignr}${upspeedgraph <IFACE> $sr{32},$sr{130} }${color}#
${endif}]]
